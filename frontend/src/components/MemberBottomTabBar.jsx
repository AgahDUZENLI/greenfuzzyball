...
const navItems = [
  ...
  { label: 'Sessions', path: '/member/sessions', icon: Calendar },
  ...
  return (
    <nav style={{
      ...
      {navItems.map(({ label, path, icon: Icon }) => {
        const active = path === '/member' ? location.pathname === '/member' : isActive(location.pathname, path)
        return (
          <button
            key={path}
